...
class profilebussinessowner extends StatefulWidget {
  static String routeName = "profilebussinessowner";
  ...
  @override
  State<profilebussinessowner> createState() => _ProfileDesignState();
}

class _ProfileDesignState extends State<profilebussinessowner> {
  File? _profileImage;
